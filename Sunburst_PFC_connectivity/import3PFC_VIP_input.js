...
function importData(id, callback) {
	...
	//Input data
	apiQuery("http://localhost/PFC/data/PFC_VIP_input.json",processExpression);
	apiQuery("http://localhost/PFC/data/PFC_VIP_input.json",processNumber);
	apiQuery("http://localhost/PFC/data/PFC_VIP_input.json",processRatio);
