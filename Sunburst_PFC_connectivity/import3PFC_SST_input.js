...
function importData(id, callback) {
	...
	//Input data
	apiQuery("http://localhost/PFC/data/PFC_SST_input.json",processExpression);
	apiQuery("http://localhost/PFC/data/PFC_SST_input.json",processNumber);
	apiQuery("http://localhost/PFC/data/PFC_SST_input.json",processRatio);
