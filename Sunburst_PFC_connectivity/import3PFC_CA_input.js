...
function importData(id, callback) {
	...
	//Input data
	apiQuery("https://www.pierrelemerre.com/Plotly/Sunburst_PFC_connectivity/data/PFC_CA_input.json",processExpression);
	apiQuery("https://www.pierrelemerre.com/Plotly/Sunburst_PFC_connectivity/data/PFC_CA_input.json",processNumber);
	apiQuery("https://www.pierrelemerre.com/Plotly/Sunburst_PFC_connectivity/data/PFC_CA_input.json",processRatio);
